                    ...
                    <div class="page-breadcrumb">
                        <div class="row align-items-center">
                            <div class="col-md-6 col-8 align-self-center">
                                <h3 class="page-title mb-0 p-0">Manager Shipper</h3>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manager Shipper</h4>
                                        <div class="table-responsive">
                                            <table class="table user-table">
                                                <thead>
                                                    <tr>
                                                        <th class="border-top-0">Shipper ID</th>
                                                        <th class="border-top-0">Number of orders being delivered</th>
                                                        <th class="border-top-0">Number of orders delivered</th>
                                                        <th class="border-top-0">Action</th>
                                                       
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <c:forEach items="${listSh}" var="o">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>${o.number2}</td>                                                          
                                                            <td>
                                                                    <a class="btn btn-success d-none d-md-inline-block text-white" href="#! ">View</a>
                                                                </td>                                                   
